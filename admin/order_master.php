				...
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table">
							...
							<tbody>
								<?php
								$res=mysqli_query($con,"select `order_document`.*,order_status.name as order_status_str from `order_document`,order_status where order_status.id=`order_document`.order_status order by `order_document`.id desc");
